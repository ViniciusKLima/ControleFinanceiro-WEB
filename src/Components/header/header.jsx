...
function Header() {
  ...
  return (
    <header
      id="header"
      className={`header d-flex justify-content-between align-items-center ${ativa ? "ativa" : ""} ${clickMenu ? "click" : ""}`}
    >
      <div className="logo">
        <svg
          width="40"
      ...
      <nav className="nav-desktop d-flex flex-column flex-lg-row justify-content-lg-start">
        <ul className="d-flex flex-column flex-lg-row align-items-end aling-items-lg-center list-unstyled m-0">
          ...
          <li className="nav-item">
            <button
              className="btn-download btn-nav"
      ...
      <button
        className="btn-menu d-lg-none d-flex align-items-center"
